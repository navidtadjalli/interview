...
class AttemptMiddlewareTestCase(CustomAPITestCase):
    def setUp(self):
        ...
        self.phone_number_attempts_keys = [key_generators.get_phone_number_attempts_key_for_login(pn)
                                           for pn in self.phone_numbers]
        self.ip_attempts_keys = [key_generators.get_ip_attempts_key_for_login(ip)
                                 for ip in self.ips]

    def call_login_endpoint(self, phone_number: str, ip: str, password: str = "password"):
    ...
    def test_if_validate_attempts_for_phone_number_and_ip_saves_into_redis(self):
        ...
        self.call_login_endpoint(self.phone_numbers[0], self.ips[0])
    ...
    def test_if_validate_attempts_count_for_phone_number_get_checked(self):
        ...
        self.call_login_endpoint(self.phone_numbers[0], self.ips[0])
        self.call_login_endpoint(self.phone_numbers[0], self.ips[1])
        self.call_login_endpoint(self.phone_numbers[0], self.ips[2])
    ...
    def test_if_validate_attempts_count_for_ip_get_checked(self):
        ...
        self.call_login_endpoint(self.phone_numbers[0], self.ips[0])
        self.call_login_endpoint(self.phone_numbers[1], self.ips[0])
        self.call_login_endpoint(self.phone_numbers[2], self.ips[0])
    ...
    def test_if_validate_phone_number_blocked_key_is_added_to_redis(self):
        ...
        self.call_login_endpoint(self.phone_numbers[0], self.ips[1])
        self.call_login_endpoint(self.phone_numbers[0], self.ips[2])
        self.call_login_endpoint(self.phone_numbers[0], self.ips[3])
    ...
    def test_if_validate_ip_blocked_key_is_added_to_redis(self):
        ...
        self.call_login_endpoint(self.phone_numbers[1], self.ips[0])
        self.call_login_endpoint(self.phone_numbers[2], self.ips[0])
        self.call_login_endpoint(self.phone_numbers[3], self.ips[0])
    ...
    def test_if_phone_number_and_ip_attempts_count_get_deleted_after_successful_login(self):
        self.reset_redis()
        ...
        self.call_login_endpoint(self.phone_numbers[0], self.ips[0])
        self.call_login_endpoint(self.phone_numbers[0], self.ips[0], password)
